...
//
//        futures.addAll(generateBlocksFamily(writer, BRICK_BROKEN_FAMILY));
//        futures.addAll(generateBlocksFamily(writer, ANDESITE_BRICK_FAMILY));
//        futures.addAll(generateBlocksFamily(writer, GRANITE_BRICK_FAMILY));
//        futures.addAll(generateBlocksFamily(writer, DIORITE_BRICK_FAMILY));
//        futures.addAll(generateBlocksFamily(writer, QUARTZ_CHECKER_FAMILY));
//        futures.addAll(generateBlocksFamily(writer, QUARTZ_TILE_FAMILY));
//        //futures.addAll(generateBlocksFamily(writer, METAL_SHEET_FAMILY));
//
//        //for (Block block : BRICK_BROKEN_FAMILY.broken())
//            //futures.addAll(generateBrokenBlockFamily(writer, block, BRICK_BROKEN_FAMILY));
//        //for (Block block : ANDESITE_BRICK_FAMILY.broken())
//            //futures.addAll(generateBrokenBlockFamily(writer, block, ANDESITE_BRICK_FAMILY));
//        //for (Block block : GRANITE_BRICK_FAMILY.broken())
//            //futures.addAll(generateBrokenBlockFamily(writer, block, GRANITE_BRICK_FAMILY));
//        //for (Block block : DIORITE_BRICK_FAMILY.broken())
//            //futures.addAll(generateBrokenBlockFamily(writer, block, DIORITE_BRICK_FAMILY));
//        //for (Block block : QUARTZ_CHECKER_FAMILY.broken())
//            //futures.addAll(generateBrokenBlockFamily(writer, block, QUARTZ_CHECKER_FAMILY));
//        //for (Block block : QUARTZ_TILE_FAMILY.broken())
//            //futures.addAll(generateBrokenBlockFamily(writer, block, QUARTZ_TILE_FAMILY));
//
...
//    }
//
//    private List<CompletableFuture<?>> generateBlocksFamily(DataWriter writer, BlockFamilyWeighted family) {
//        List<CompletableFuture<?>> _list = new ArrayList<>();
//
//        for (Block block : family.broken())
//            _list.addAll(generateBrokenBlockFamily(writer, block, family));
//
//        return _list;
//    }
//
...
//            DataWriter writer,
//            Block brokenBlock,
//            BlockFamilyWeighted family
//    ) {
//        if (family.weights().length != 8) {
...
//
//        return switch (type) {
//            case CUBE -> generateBrokenCubeBlockFamily(writer, brokenBlock, family);
//            case SLAB -> generateBrokenSlabBlockFamily(writer, brokenBlock, family);
//            case STAIRS -> generateBrokenStairsBlockFamily(writer, brokenBlock, family);
//            case WALL -> generateBrokenWallBlockFamily(writer, brokenBlock, family);
//        };
//    }
//
...
//        String base = basePath(family.getFamilyBaseModel());
//
//        String baseNs = family.isVanillaFamily() ? "minecraft" : namespace;
